    ...
    <div class="container mx-auto p-4">
      ...
      <div class="flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-2/3 bg-white p-6 rounded shadow-md">
          ...
          <form>
            <div class="mb-4">
              <input v-model="fullName" class="w-full p-2 border border-gray-300 rounded" placeholder="Họ và tên" type="text"/>
            </div>
            <div class="mb-4">
              <input v-model="email" class="w-full p-2 border border-gray-300 rounded" placeholder="Email" type="email"/>
            </div>
            <div class="mb-4">
              <input v-model="phone" class="w-full p-2 border border-gray-300 rounded" placeholder="Số điện thoại" type="text"/>
            </div>
            <div class="mb-4">
              <input v-model="address" class="w-full p-2 border border-gray-300 rounded" placeholder="Địa chỉ" type="text"/>
            </div>

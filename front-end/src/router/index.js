...
const routes = [
    {
        path: '/product-detail', // Thêm :id để hỗ trợ dynamic param
        name: 'ProductDetail',
        component: () => import('@/views/pages/ProductDetail.vue'),
    },
    {
        path: '/product-detail2', // Thêm :id để hỗ trợ dynamic param
        name: 'ProductDetail2',
    ...
    {
        path: '/category/management', // Thêm :id để hỗ trợ dynamic param
    ...
    },
    {
        ...
        children: [
            ...
            // {
            //   path: '/product-detail/:id', // Thêm :id để hỗ trợ dynamic param
            //   name: 'ProductDetail',
            //   component: () => import('@/views/pages/ProductDetail.vue'),
            //   props: true, // Truyền param id vào component dưới dạng prop
            // },

...
public class User extends AbstractEntity<String> implements UserDetails {
    ...
    public boolean equals(Object object) {
        ...
        return Objects.equals(firstName, user.firstName) && Objects.equals(lastName, user.lastName) && Objects.equals(dob, user.dob) && Objects.equals(email, user.email) && Objects.equals(phone, user.phone) && Objects.equals(refreshToken, user.refreshToken) && userStatus == user.userStatus && gender == user.gender && Objects.equals(password, user.password);
    }

    @Override
    public int hashCode() {
        return Objects.hash(firstName, lastName, dob, email, phone, refreshToken, userStatus, gender, password);
    }
}
